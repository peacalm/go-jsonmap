...
func TestGet(t *testing.T) {
	...
	fmt.Println("GetInt64 with useNumber=false (real value 7095620078347567873):", longint1)
	fmt.Println("GetInt64 with useNumber=true  (real value 7095620078347567873):", longint2, ". eq? ", longint1 == longint2)
